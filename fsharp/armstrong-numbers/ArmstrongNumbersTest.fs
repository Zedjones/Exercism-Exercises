...
[<Fact>]
let ``Zero is an Armstrong number`` () = isArmstrongNumber 0 |> should equal true

[<Fact>]
let ``Single digit numbers are Armstrong numbers`` () = isArmstrongNumber 5 |> should equal true
